...
- [x] **MAUI: перевод на EN** — UI сейчас частично на русском
...
- [x] **MAUI: карточки** - 2 - лимитировать как-то тэги, чтобы влазило, 5 - не влазят цифры, 8 - не влазит последнее комбо
